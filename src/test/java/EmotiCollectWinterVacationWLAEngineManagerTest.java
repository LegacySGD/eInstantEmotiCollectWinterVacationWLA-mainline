...
public class EmotiCollectWinterVacationWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EmotiCollectWinterVacationWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EmotiCollectWinterVacationWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EmotiCollectWinterVacationWLAIW/InitOutcome.xml").getDocumentElement();
